...
public:
  CreateIndexStmt(
      Table *table, const std::vector<const FieldMeta *> field_meta, const std::string &index_name, bool is_unique)
...
private:
  ...
  const std::vector<const FieldMeta *> field_meta_;  // 预留multiindex
